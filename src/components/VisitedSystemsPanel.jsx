...
const VisitedSystemsPanel = ({ stars }) => {
    ...
    return (
        <div className="absolute bottom-12 left-4 bg-gray-800 bg-opacity-95 border border-green-500 p-4 rounded-md text-sm text-green-300 shadow-xl w-72 max-h-76 overflow-y-auto">
